<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberOnly.aspx.cs" Inherits="WebDev_CW.MemberOnly" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <a class="cart" href="Cart.aspx"><ion-icon name="cart-outline"></ion-icon><span>0</span></a>
        ...
        <asp:Label ID="member" runat="server" Text=""></asp:Label><br />
        <!---Home Section---->
    ...
    <!---Footer Section---->
     ...
     <script src="js/MemberOnly.js"></script>
